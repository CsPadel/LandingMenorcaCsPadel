  ...
  en: {
    translation: {
      ...
      bookingForm: {
        ...
        levelLabel: "Playing Level",
        levelOptions: ["1 — Beginner", "2 — Novice", "3 — Intermediate", "4 — Advanced", "5 — Competition"],
        courtSideLabel: "Preferred Court Side",
        courtSideOptions: ["Right (Drive)", "Left (Backhand)", "Either"],
        withPartnerLabel: "Registering with a partner?",
        withPartnerYes: "Yes",
        withPartnerNo: "No",
        partnerNameLabel: "Partner's Name",
        partnerNamePlaceholder: "Partner's full name",
        tshirtSizeLabel: "T-Shirt Size",
        tshirtCutLabel: "T-Shirt Cut",
        tshirtCutOptions: ["Men's", "Women's"],
        ...
        successSubtitle: "Thank you. Choose your room below to secure your place with a deposit.",
        paymentDoubleLabel: "Double Room",
        paymentDoublePrice: "from £1,850 pp",
        paymentPrivateLabel: "Private Room",
        paymentPrivatePrice: "from £2,400 pp",
        payBtn: "Pay Deposit →",
        discountToggle: "Have a discount code?",
        discountPlaceholder: "Enter code",
        discountApplyBtn: "Apply",
        discountInvalidMsg: "Code not recognised.",
        discountUnlockedLabel: "Discounted Rate",
        discountUnlockedPrice: "£1,500 pp",
  ...
  es: {
    translation: {
      ...
      bookingForm: {
        ...
        levelLabel: "Nivel de Juego",
        levelOptions: ["1 — Iniciación", "2 — Básico", "3 — Intermedio", "4 — Avanzado", "5 — Competición"],
        courtSideLabel: "Lado de Pista Preferido",
        courtSideOptions: ["Derecha (Drive)", "Izquierda (Revés)", "Indiferente"],
        withPartnerLabel: "¿Te inscribes con pareja?",
        withPartnerYes: "Sí",
        withPartnerNo: "No",
        partnerNameLabel: "Nombre de tu Pareja",
        partnerNamePlaceholder: "Nombre completo de tu pareja",
        tshirtSizeLabel: "Talla de Camiseta",
        tshirtCutLabel: "Corte de Camiseta",
        tshirtCutOptions: ["Hombre", "Mujer"],
        submitBtn: "Enviar Solicitud",
        submittingBtn: "Enviando…",
        errorMsg: "Algo salió mal. Inténtalo de nuevo o escríbenos por WhatsApp.",
        requiredHint: "Los campos marcados con * son obligatorios",
        successTitle: "Solicitud Recibida",
        successSubtitle: "Gracias. Elige tu habitación para asegurar tu plaza con un depósito.",
        paymentDoubleLabel: "Habitación Doble",
        paymentDoublePrice: "desde 1.850 £ p.p.",
        paymentPrivateLabel: "Habitación Privada",
        paymentPrivatePrice: "desde 2.400 £ p.p.",
        payBtn: "Pagar Depósito →",
        discountToggle: "¿Tienes un código de descuento?",
        discountPlaceholder: "Introduce el código",
        discountApplyBtn: "Aplicar",
        discountInvalidMsg: "Código no reconocido.",
        discountUnlockedLabel: "Tarifa con Descuento",
        discountUnlockedPrice: "1.500 £ p.p.",
  ...
  fr: {
    translation: {
      ...
      bookingForm: {
        ...
        levelLabel: "Niveau de Jeu",
        levelOptions: ["1 — Débutant", "2 — Novice", "3 — Intermédiaire", "4 — Avancé", "5 — Compétition"],
        courtSideLabel: "Côté de Court Préféré",
        courtSideOptions: ["Droite (Coup Droit)", "Gauche (Revers)", "Indifférent"],
        withPartnerLabel: "Vous inscrivez-vous avec un partenaire ?",
        withPartnerYes: "Oui",
        withPartnerNo: "Non",
        partnerNameLabel: "Nom de votre Partenaire",
        partnerNamePlaceholder: "Nom complet du partenaire",
        tshirtSizeLabel: "Taille de T-Shirt",
        tshirtCutLabel: "Coupe du T-Shirt",
        tshirtCutOptions: ["Homme", "Femme"],
        submitBtn: "Envoyer la Demande",
        submittingBtn: "Envoi en cours…",
        errorMsg: "Une erreur est survenue. Réessayez ou contactez-nous sur WhatsApp.",
        requiredHint: "Les champs marqués * sont obligatoires",
        successTitle: "Demande Reçue",
        successSubtitle: "Merci. Choisissez votre chambre ci-dessous pour réserver votre place avec un acompte.",
        paymentDoubleLabel: "Chambre Double",
        paymentDoublePrice: "à partir de 1 850 £ p.p.",
        paymentPrivateLabel: "Chambre Privée",
        paymentPrivatePrice: "à partir de 2 400 £ p.p.",
        payBtn: "Payer l'Acompte →",
        discountToggle: "Vous avez un code de réduction ?",
        discountPlaceholder: "Entrez le code",
        discountApplyBtn: "Appliquer",
        discountInvalidMsg: "Code non reconnu.",
        discountUnlockedLabel: "Tarif Réduit",
        discountUnlockedPrice: "1 500 £ p.p.",
