  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6 md:px-16 text-center">
        <p className="text-xs uppercase tracking-[0.3em] text-brand-gold font-semibold mb-4">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          {Array.isArray(features) &&
            features.map((feature, idx) => (
              <div
                key={idx}
                className="border border-brand-dark/15 rounded-full px-6 py-2.5 bg-brand-dark/5"
              >
